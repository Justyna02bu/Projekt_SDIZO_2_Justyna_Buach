...
public:
    ...
    void dijkstra_lc(int lista[10000][3], int wierzcholek_poczatkowy, int rozmiar, string nazwa, int wierz);

    void dijkstra_l(int lista[10000][3], int wierzcholek_poczatkowy, int rozmiar, int wierz);
